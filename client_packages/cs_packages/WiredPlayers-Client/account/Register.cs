...
namespace WiredPlayers_Client.account
{
    class Register : Events.Script
    {
        ...
        public static void ShowRegisterForm()
        {
            ...
            Browser.CreateBrowser("connection.html", null, "showRegister", AccountHandler.SocialName);
        }
        ...
        private void ShowApplicationTestEvent(object[] args)
        {
            ...
            Browser.CreateBrowser("application.html", null, "initializeApplication", args[0].ToString(), args[1].ToString());
        }
        ...
        private void FailedApplicationEvent(object[] args)
        {
            ...
            // Show the mistakes
            Browser.ExecuteFunction("showApplicationMistakes", mistakes);
        }
