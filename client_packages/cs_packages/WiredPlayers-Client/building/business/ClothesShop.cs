...
namespace WiredPlayers_Client.Building.Business
{
    class ClothesShop : Events.Script
    {
        ...
        private void ShowClothesBusinessPurchaseMenuEvent(object[] args)
        {
            ...
            // Show clothes menu
            Browser.CreateBrowser("sideMenu.html", "closeClothesMenu", "populateClothesShopMenu", JsonConvert.SerializeObject(Constants.ClothesTypes), business, price, args[2].ToString());
        }
        ...
        private void GetClothesByTypeEvent(object[] args)
        {
            ...
            // Get clothes list
            Events.CallRemote("getClothesByType", Constants.ClothesTypes[selectedIndex].type, Constants.ClothesTypes[selectedIndex].slot);
        }
        ...
        private void ShowTypeClothesEvent(object[] args)
        {
            ...
            int type = Constants.ClothesTypes[selectedIndex].type;
            int slot = Constants.ClothesTypes[selectedIndex].slot;
            ...
            Browser.ExecuteFunction("populateTypeClothes", Globals.EscapeJsonCharacters(JsonConvert.SerializeObject(clothesTypes)));
        }
        ...
        private void PurchaseClothesEvent(object[] args)
        {
            ...
            Events.CallRemote("ClothesItemSelected", JsonConvert.SerializeObject(clothesModel), clothesTypes[index].bodyPart);
        }
