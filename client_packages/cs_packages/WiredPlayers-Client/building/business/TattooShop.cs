...
namespace WiredPlayers_Client.Building.Business
{
    class TattooShop : Events.Script
    {
        ...
        private void ShowTattooMenuEvent(object[] args)
        {
            ...
            string tattooZoneJson = JsonConvert.SerializeObject(Constants.TattooZones);

            // Remove the tattoos which are not part of the player
            tattooList.RemoveAll(t => (t.maleHash == string.Empty && playerSex == (int)PlayerSex.Male) || (t.femaleHash == string.Empty && playerSex == (int)PlayerSex.Female));
            ...
            // Show tattoos menu
            Browser.CreateBrowser("sideMenu.html", "exitTattooShop", "populateTattooMenu", tattooZoneJson, business, price);
        }
        ...
        private void GetZoneTattoosEvent(object[] args)
        {
            ...
            Browser.ExecuteFunction("populateZoneTattoos", Globals.EscapeJsonCharacters(JsonConvert.SerializeObject(zoneTattoos)));
        }
        ...
        private void AddPlayerTattooEvent(object[] args)
        {
            ...
            uint tattooHash = playerSex == (int)PlayerSex.Male ? RAGE.Game.Misc.GetHashKey(zoneTattoos[index].maleHash) : RAGE.Game.Misc.GetHashKey(zoneTattoos[index].femaleHash);
        ...
        private void PurchaseTattooEvent(object[] args)
        {
            ...
            Tattoo tattoo = new Tattoo();
            {
                ...
                tattoo.hash = playerSex == (int)PlayerSex.Male ? zoneTattoos[index].maleHash : zoneTattoos[index].femaleHash;
            }
